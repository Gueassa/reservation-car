...
#viewer_modal .modal-dialog {
  ...
  body,main {
    background: #d7d3d9!important;
    padding-bottom: 15px;
}
footer{
  background: #261834 !important;
}
  ...
  <header class="masthead">
       ...
       <div class="container h-100">
            <div class="row h-100 align-items-center justify-content-center text-center">
                <div class="col-lg-8 align-self-end mb-4 page-title">
                  <h3 class="text-white">Bienvenue à  donkey-car </h3>
                ...
                <div class="col-md-12 mb-2 justify-content-center">
                  <form action="" id="find-car">
                    <div class="row form-group">
                      <div class="col-md-4">
                        <label for="" class="control-label text-white">Date de début/Time</label>
                        <input type="text" class="form-control datetimepicker" required="" name="pickup" autocomplete="off">
                      </div>
                      <div class="col-md-4">
                        <label for="" class="control-label text-white">Date de fin/Temps</label>
                        <input type="text" class="form-control datetimepicker" required="" name="dropoff" autocomplete="off">
                      </div>
                      <div class="col-md-4">
                        <label for="" class="control-label text-white">categories</label>
                    ...
                    <div class="form-group ">
                      <center>
                        <button class="btn btn-primary">Trouve la disponible</button>
                      </center>
                    </div>
                  </form>
                </div>                        
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
          <img src="donkey-removebg-preview" alt="" height="47px" width="50px" >
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=login">Se connecter</a></li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=about">Business</a></li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=about">Louer ma voiture</a></li>
                    </ul>
                </div>
            </div>
        </nav>
...
<div class="modal fade" id="confirm_modal" role='dialog'>
  ...
  <div id="preloader"></div>
        <footer class=" py-5">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center">
                        <h2 class="mt-0 text-white">Contactez Nous</h2>
                        <hr class="divider my-4" />
                    </div>
                </div>
                <div class="row">
            ...
            <br>
            <div class="container"><div class="small text-center text-muted"> © 2023 - <?php echo $_SESSION['system']['name'] ?>  <a href="" target="_blank"></a></div></div>
        </footer>
